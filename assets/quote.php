...
$e_body = "You have been contacted by $name_quote $lastname_quote with the following message:" . PHP_EOL . PHP_EOL;
$e_content = "$message_quote" . PHP_EOL . PHP_EOL;
$e_reply = "You can contact $name_quote via email: $email_quote, via telephone: $phone_quote or web $url_quote.";
...
$usermessage = "Thank you for contact us. We will reply shortly with more details. Here a summary of your request: \n\n$e_content.  \n\n Call 0034 434324  for further information.";
...
if(mail($address, $e_subject, $msg, $headers)) {
	...
	echo "<div style='font-size:90px; font-weight:normal; margin-bottom:20px;color:#acd277;'><i class='icon_check'></i></div>";
